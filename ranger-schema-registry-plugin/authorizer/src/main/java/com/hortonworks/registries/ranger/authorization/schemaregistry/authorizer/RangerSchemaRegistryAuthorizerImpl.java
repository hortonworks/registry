...
public class RangerSchemaRegistryAuthorizerImpl implements Authorizer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        boolean isAuthorized = authorizer.authorizeSchema(sGroup, sMetadataName, ACCESS_TYPE_READ,
                user, groups);
        ...
        isAuthorized = authorizer.authorizeSchemaBranch(sGroup, sMetadataName, sBranch, ACCESS_TYPE_READ,
                user, groups);
