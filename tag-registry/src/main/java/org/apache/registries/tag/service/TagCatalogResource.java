package org.apache.registries.tag.service;

import com.codahale.metrics.annotation.Timed;
import org.apache.registries.common.QueryParam;
import org.apache.registries.common.util.WSUtils;
import org.apache.registries.tag.Tag;
import org.apache.registries.tag.TaggedEntity;
...
import static org.apache.registries.common.catalog.CatalogResponse.ResponseMessage.ENTITY_NOT_FOUND;
import static org.apache.registries.common.catalog.CatalogResponse.ResponseMessage.ENTITY_NOT_FOUND_FOR_FILTER;
import static org.apache.registries.common.catalog.CatalogResponse.ResponseMessage.EXCEPTION;
import static org.apache.registries.common.catalog.CatalogResponse.ResponseMessage.SUCCESS;
    ...
    public Response addTagForEntity(@PathParam("id") Long tagId, @PathParam("namespace") String namespace, @PathParam("entity-id") Long entityId) {
        try {
            ...
            if(tag != null) {
                ...
                return WSUtils.respond(tagId.toString(), BAD_REQUEST, ENTITY_NOT_FOUND);
            }
        } catch (Exception ex) {
            return WSUtils.respond(INTERNAL_SERVER_ERROR, EXCEPTION, ex.getMessage());
        }
