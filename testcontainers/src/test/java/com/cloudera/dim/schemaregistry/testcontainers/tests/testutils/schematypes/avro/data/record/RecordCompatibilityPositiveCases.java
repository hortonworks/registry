...
import static com.cloudera.dim.schemaregistry.testcontainers.tests.testutils.schematypes.avro.data.record.RecordConstants.SCHEMA_WITH_BACKWARD_COMPATIBILITY;
import static com.cloudera.dim.schemaregistry.testcontainers.tests.testutils.schematypes.avro.data.record.RecordConstants.SCHEMA_WITH_BOTH_COMPATIBILITY;
import static com.cloudera.dim.schemaregistry.testcontainers.tests.testutils.schematypes.avro.data.record.RecordConstants.SCHEMA_WITH_FORWARD_COMPATIBILITY;
...
import static com.cloudera.dim.schemaregistry.testcontainers.tests.testutils.schematypes.avro.data.record.RecordConstants.SCHEMA_WITH_NONE_COMPATIBILITY;
...
public class RecordCompatibilityPositiveCases extends CompatibiltyPositiveNegativeTestCases {
    private final RecordCompatibilityTestCaseGenerator compatibilityTestGenerator = new
            RecordCompatibilityTestCaseGenerator(schemaRegistryClient);

    public RecordCompatibilityPositiveCases(ISchemaRegistryClient schemaRegistryClient) {
