...
public class JsonSnapshotSerializer extends AbstractJsonSnapshotSerializer<byte[]> {

  public JsonSnapshotSerializer() { }

  public JsonSnapshotSerializer(ISchemaRegistryClient schemaRegistryClient) {
