...
public final class SchemaVersionInfo implements Serializable {
    ...
    public SchemaVersionInfo(SchemaVersionStorable schemaVersionStorable) {
        description = schemaVersionStorable.getDescription();
        version = schemaVersionStorable.getVersion();
        schemaText = schemaVersionStorable.getSchemaText();
        timestamp = schemaVersionStorable.getTimestamp();
    }
