...
public class SchemaFieldQuery {
    ...
    public Map<String, String> toQueryMap() {
        ...
        if(name != null) {
            queryMap.put(SchemaFieldInfoStorable.NAME, name);
        }
        if(namespace != null) {
            queryMap.put(SchemaFieldInfoStorable.FIELD_NAMESPACE, namespace);
        }
        if(type != null) {
            queryMap.put(SchemaFieldInfoStorable.TYPE, type);
        }
