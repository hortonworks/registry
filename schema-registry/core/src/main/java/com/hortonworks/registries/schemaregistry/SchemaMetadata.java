...
import static com.hortonworks.registries.schemaregistry.SchemaProvider.DEFAULT_COMPATIBILITY;
...
public class SchemaMetadata implements Serializable {
    ...
    private SchemaMetadata(String name, String type, String schemaGroup, String description, SchemaProvider.Compatibility compatibility) {
        ...
        this.compatibility = (compatibility != null) ? compatibility : DEFAULT_COMPATIBILITY;
    }
