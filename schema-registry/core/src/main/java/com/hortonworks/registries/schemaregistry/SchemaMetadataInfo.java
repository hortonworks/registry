...
public final class SchemaMetadataInfo implements Serializable {
    ...
    public SchemaMetadataStorable toSchemaInfoStorable() {
    ...
    public static SchemaMetadataInfo fromSchemaInfoStorable(SchemaMetadataStorable schemaMetadataStorable) {
