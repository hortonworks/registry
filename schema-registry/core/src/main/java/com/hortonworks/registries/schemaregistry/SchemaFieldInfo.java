...
public class SchemaFieldInfo implements Serializable {
    ...
    public SchemaFieldInfoStorable toFieldInfoStorable() {
       return toFieldInfoStorable(id);
    }


    public SchemaFieldInfoStorable toFieldInfoStorable(Long id) {
        SchemaFieldInfoStorable schemaFieldInfoStorable = new SchemaFieldInfoStorable(id);
        schemaFieldInfoStorable.setFieldNamespace(namespace);
        schemaFieldInfoStorable.setName(name);
        schemaFieldInfoStorable.setType(type);
